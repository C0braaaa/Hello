...
<body>
    ...
    <select id="city" name="city">
        ...
        <option value="quangbing">Quảng Bình</option>
    ...
    <lable>Nghề Nghiệp: </lable><br>
    <input type="text"><br>
    
    <lable>Giao Hàng: </lable>
    <input type="checkbox" value="taihoc"> Tại nhà
    <input type="checkbox" value="taicoquan"> Tại cơ quan
    <input type="checkbox" value="khac"> Khác
    <br>
    
    <input type="reset" value="Reset">
	<input type="submit" value="Confirm" id="submit"><br>
	<a href="https://www.manutd.com/">Link 1</a>
	<a href="hello.jsp">Link 2</a>
	<a href="/TEST_HELLO/demo">Link servlet.</a>
	<a href="hajfjashfaf.jsp">link erros 404</a>
</body>
</html>